...
for (e in unique(binFractionsA20$expt)){
  ...
  guideLevelStats = findGuideHitsAllScreens(experiments = unique(curCountMat["screen"]), countDataFrame = curCountMat, binStats = curBins2, sortBins = c("A","B","C","D","E","F"), unsortedBin = "NS", nonTargeting="NT")
